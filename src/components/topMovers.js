...
const topMovers = () => {
  return (
    <div className="flex flex-col w-full max-w-lg p-4 my-6 bg-white border rounded-lg shadow-sm border-slate-200">
    ...
    <div className="mt-6">
        <p className="text-base font-light leading-normal text-slate-600">
